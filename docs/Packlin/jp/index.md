...
操作手間の最小化を目指しました。よくある「確認」ボタンはありません、編集後の「保存」ボタンもありません。「削除」ボタンは確認なしに即削除します。間違ったならば「Undo」ボタンで前の状態に戻せます

チャッピー(AI)にパックの作成や修正を依頼できるようになりました（内部課金）。ただし、結果の正しさは保証できませんのでテンプレートとして参考にしながら修正してお使いください
...
2025年8月24日 新規アプリとして提出したところ、Apple審査落ち、理由は「類似アプリあり、新規性なし」仕方なく旧アプリのアップデートにして公開、これぞ既得権かな

    - 2025年9月4日 8:58 カルメモ／CalcRoll 2.0 公開

2025年9月 カルメモ公開後、モチメモもSwiftUI移行を始めた。10月には従来からの課題も解決したalpha版が出来上がり、その初期画面に表示させるサンプルデータをAIに作らせたところ良い感じだった。そこで「チャッピー(AI)に依頼する」新機能を取り入れようとした結果、世界規模のスケーラブルAPIサーバの開発と運用まで必要になり大幅に遅延した

    - 2025年11月30日 x:xx モチメモ／Packlin 3.0 公開
...
| 2.1.3    | 2017/9/28  |  
|----------|------------|
| 3.0      | 2025/11/  | モチメモ／Packlin Xcode26,SwiftUI,SwiftData
